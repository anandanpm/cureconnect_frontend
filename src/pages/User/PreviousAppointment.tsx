...
//     try {
//       const history: AppointmentHistory[] = await fetchcancelcompleteAppointmentdetails(userId)
//       console.log(history,'the fetchappointmentDetails is comming')
...
//                   <p><strong>Original Amount:</strong> ${selectedAppointment.amount?.toFixed(2)}</p>
//                   {/* {selectedAppointment.status === "Cancelled" && (
//                     <p><strong>Refund Amount:</strong> ${selectedAppointment.refundAmount?.toFixed(2) || (selectedAppointment.amount ? (selectedAppointment.amount * 0.5).toFixed(2) : '0.00')}</p>
//                   )} */}
//                   <p><strong>Payment Refund Amount:</strong> {selectedAppointment.refund }</p>
//                 </div>
//               </div>
...
//     function handleChat(appointmentId: any): void {
//       navigate(`/chat/${appointmentId}`)
//     }

//     function handleprescribtion = (appointmentId: string) => {
//       console.log(appointmentId, 'the appointment id is comming or not')
...
//                   variant="contained"
//                   startIcon={<Info />}
//                   onClick={() => handleprescribtion(appointment.appointmentId)}
//                   className="action-button details"
//                 >
//                   prescribtion
//                 </Button>
